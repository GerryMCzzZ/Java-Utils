...
public class AlySmsUtils {
    ...
    //自定义短信静态类
    public static void smsToStu(String telephone, String code) throws ClientException {
        String templateCode = "SMS_132695077"; //在阿里云官网注册的短信模板码
    ...
    public static SendSmsResponse sendSms(String telephone, String code, String templateCode) throws ClientException {
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("*****");   //阿里官网注册的短信签名名称
        // 必填:短信模板-可在短信控制台中找到
